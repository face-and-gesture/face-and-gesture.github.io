...
if __name__ == "__main__":
    ...
    default_group.add_argument('-o', '--organizers',
                               action='store_const', const=True,
                               help='Create Markdown files for organizers')
    ...
    if args.frab:
    ...
    elif args.talks or args.speakers or args.rooms or args.organizers or args.create_files:
        ...
        elif args.organizers:
            file_args = default_file_structure['organizers']
            file_attrs = default_file_attrs['organizers']
        else:
            file_args = {}
            file_attrs = []
